                ...
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        ...
                        <div className="flex flex-wrap justify-center lg:justify-start gap-4">
                            <a href="https://github.com/ankitvijay2004" target="_blank" rel="noreferrer" className={`p-4 rounded-xl transition-all border hover:scale-105 ${isDark ? 'bg-white/5 border-white/10 hover:bg-white/10 text-white' : 'bg-white border-slate-200 hover:shadow-lg text-slate-800'}`}>
                                <GithubIcon />
                            </a>
                            <a href="http://www.linkedin.com/in/ankit-kumar-vijay-276924285" target="_blank" rel="noreferrer" className={`p-4 rounded-xl transition-all border hover:scale-105 ${isDark ? 'bg-white/5 border-white/10 hover:bg-white/10 text-white' : 'bg-white border-slate-200 hover:shadow-lg text-blue-700'}`}>
                                <LinkedInIcon />
                            </a>
                            <a href="https://www.instagram.com/ankit_k_vijay/" target="_blank" rel="noreferrer" className={`p-4 rounded-xl transition-all border hover:scale-105 ${isDark ? 'bg-white/5 border-white/10 hover:bg-white/10 text-white' : 'bg-white border-slate-200 hover:shadow-lg text-pink-600'}`}>
                                <InstagramIcon />
                            </a>
                             <a href="mailto:ankitvijay100@gmail.com" className={`p-4 rounded-xl transition-all border hover:scale-105 ${isDark ? 'bg-white/5 border-white/10 hover:bg-white/10 text-white' : 'bg-white border-slate-200 hover:shadow-lg text-red-500'}`}>
                                <MailIcon />
                            </a>
                        </div>
                    </motion.div>
